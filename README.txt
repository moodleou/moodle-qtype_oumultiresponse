...
To install using git, type this command in the root of your Moodle install
    git clone git://github.com/timhunt/moodle-qtype_oumultireponse.git question/type/oumultiresponse
Then add question/type/oumultiresponse to your git ignore.

Alternatively, download the zip from
    https://github.com/timhunt/moodle-qtype_oumultireponse/zipball/master
...
choice. So for example, suppose the quesiton is:
